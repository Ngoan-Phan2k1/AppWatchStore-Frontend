        ...
        <View style={styles.container}>
            ...
            {cart?.length > 0 ? (
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.amountContainer}>
                                <View style={styles.amountSubContainer}>
                                    <Text style={styles.amountLabelText}>Product Total</Text>
                                ...
                                <View style={styles.amountSubContainer}>
                                    ...
                                    <Text style={{...styles.amountText, color: Colors.DEFAULT_GREEN}}>Free</Text>
                                </View>
                        </View>
                ...
                <View style={styles.emptyCartContainer}>
                    ...
                    <Text style={styles.emptyCartSubText}>Go ahead and order</Text>
                    <TouchableOpacity style={styles.addButtonEmpty}>
                        <AntDesign 
                            ...
                            size={20}
                        />
                        <Text style={styles.addButtonEmptyText}>Add Product</Text>
                    </TouchableOpacity>
