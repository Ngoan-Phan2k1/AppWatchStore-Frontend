...
const Pagination = ({index}) => {
    return (
        <View style={styles.pageContainer}>
            {[...Array(General.WELCOME_CONTENTS.length).keys()].map((_, idx) => 
                idx === index ? (
                    <View style={pageStyle(true)} key={idx}/>
                ) : (
                    <View style={pageStyle(false)} key={idx}/>
                )
            )}
        ...
        <View style={styles.container}>
            ...
            <View style={styles.welcomeListContainer}>
                <FlatList
                    ...
                    horizontal //hien thi theo ch ngang
                    showsHorizontalScrollIndicator={false}
                    pagingEnabled  //Lam cho hieu ung chuyen man hinh muot hon
...
const styles = StyleSheet.create({
    ...
    page: {  //Những dấu gạch dưới trang
        height: 8,
        width: 15,
