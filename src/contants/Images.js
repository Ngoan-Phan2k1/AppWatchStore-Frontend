export default {
    ...
    //PLATE: require('../assets/images/plate_v4.png'),
    PLATE: require('../assets/images/plate_v6.png'),
    ...
    MECHANICAL_WATCH: require('../assets/images/co.png'),
    DEGITAL_WATCH: require('../assets/images/dientu.png'),
    LIMIT_WATCH: require('../assets/images/limit.png'),
